...
Download the newest Windows (`.exe`) or macOS (`.dmg`) installer from [GitHub Releases](https://github.com/cfanfelle/Bible-Trivia/releases/latest). Installed copies check for updates automatically and preserve all local profiles and progress.
